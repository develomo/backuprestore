...
if "st['selected_style_id'] = style_id" not in c: 
...
if c!=o: 
    ...
    print('SUCCESS: Master Patch Applied!') 
else: 
    print('NO CHANGES MADE (Already patched or missing text)') 
os.makedirs('assets/brolls',exist_ok=True) 
os.makedirs('assets/logos',exist_ok=True) 
print('Folders Ready: assets/brolls and assets/logos') 
