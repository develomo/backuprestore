...
def run_integrated_long_pipeline(voice_path=None, clips=None, words=None, words_path=None, transcript_text=None, output_path=None, niche="default", render_count=0, caption_mode="phrase", style_id=None, music_path=None, sfx_files=None, use_hook=True, hook_text=None, use_overlays=True, final_4k=False, fps=24, quality=None, clean_silence=False, add_captions=True, preset_overrides=None, custom_logo_path=None, wm_opacity=0.6, subscribe_overlay=None, **kwargs):
    ...
    q=normalize_quality(preset.get("quality",preset.get("batch_quality",quality or DEFAULT_SETTINGS["edit_quality"]))); fps_val=min(24,max(12,int(preset.get("fps",fps or DEFAULT_SETTINGS["fps"])))); batch_size=min(4, int(preset.get("batch_size", 4) or 4))  # 🌡️ THERMAL SAFE: Force batch_size=4 for RAM safety (reduced from 8)
